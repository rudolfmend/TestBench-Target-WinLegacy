...
namespace TestBench_Target_WinLegacy
{
    public partial class Form2 : Form
    {
        ...
        private string GetDefaultJsonFilePath()
        {
            ...
            return Path.Combine(documentsFolder, "TestBenchTargetWinLegacy.json");
        }
        ...
        private void SaveDataWithDialog()
        {
            using (SaveFileDialog saveFileDialog = new SaveFileDialog())
            {
                ...
                saveFileDialog.FileName = "TestBenchTargetWinLegacy.json";
        ...
        private void DataGridView1_CellParsing(object sender, DataGridViewCellParsingEventArgs e)
        {
            if (DataGridView1.Columns[e.ColumnIndex].Name == "ColumnPoints")
            {
                try
                {
                    ...
                    {
                        e.Value = 0;
                        e.ParsingApplied = true; // Mark that the value is processed
                        return;
                    }
